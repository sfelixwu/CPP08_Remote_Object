...
class myroServer : public roServer
{
public:
  myroServer(jsonrpc::AbstractServerConnector &conn, jsonrpc::serverVersion_t type);
...
myroServer::myroServer(AbstractServerConnector &connector, serverVersion_t type)
  : roServer(connector, type)
{
  std::cout << "myroServer Object created" << std::endl;
}

// member functions

Json::Value
myroServer::setGPSLabel
